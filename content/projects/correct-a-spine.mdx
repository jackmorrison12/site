...
<DoubleImg
  img1Props={{ src: '/img/cas-2.png', alt: 'Correct-a-Spine Flex Sensor', height: '2057', width: '2448' }}
  img2Props={{ src: '/img/cas-1.png', alt: 'Correct-a-Spine Accelerometer', height: '1620', width: '1668' }}
/>
