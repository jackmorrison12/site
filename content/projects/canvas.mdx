...
Our app uses a dual connection mechanism, making use of an <span className="highlight">XMPP</span> server, for long-distance drawing, and a <span className="highlight">Bluetooth</span> mesh topology, for optimised close-range drawing
